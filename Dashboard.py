...
scatter = px.scatter(
    ...
    hover_data={'DeveloperCount': False, 'DeveloperCountJitter': False, 'Genere': True},
    template=None
)
...
def update_line_chart(clickData=None):
    ...
    max_sales_by_year = G_Games.loc[G_Games.groupby('Year')[region_sales_column].idxmax().values]
